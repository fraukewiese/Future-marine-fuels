...
\noindent Emission Budget: The CO2e emission budget must be greater or equal to the total systems up- and downstream emissions.
\begin{subequations}
    \begin{align}
...
\end{subequations}
\par\noindent
Emission Target: Limits the CO2e emissions from the selected year (2050) on-wards.
\begin{equation}
