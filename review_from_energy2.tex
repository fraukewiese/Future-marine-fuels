...
Answer: We agree, sent it for proofreading and included the changes.

- does the recent decision in the lastest MEPC to strengthen the EEDI affect the likley scenarios and assumptions?
Answer: Good question. The latest MEPC took place after this research project was conducted. We assume, that a strengthening of the EEDI would decrease the total fuel consumption as we would most likely implement it as a transport work per fuel consumption improvement in our model. This could then lead to an extended use of fossil fuels. In principal, we wouldn't expect any significant changes to the overall trends in the different scenarios.
