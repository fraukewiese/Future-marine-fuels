...
%DIF <  LNG is no option, LBG just if methane leakage phase out
...
\end{minipage}\DIFdelbegin %DIFDELCMD < \\[0.75cm]
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\ %DIF > [0.75cm]
\DIFaddend 
